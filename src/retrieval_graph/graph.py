...
def route_query(
    ...
    """Route the user's question based on the router classification."""
    ...
    if query_type == "research":
        ...
        raise ValueError(f"Unknown router type: {query_type}")
...
async def conduct_research(state: AgentState) -> dict[str, Any]:
    ...
    print(
        f"\n--- RESEARCH COMPLETE: "
        f"{len(result.get('documents', []))} documents retrieved ---"
    )
